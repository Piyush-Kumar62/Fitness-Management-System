...
@Component({
  ...
  template: `
    ...
    >
      ...
      ></div>
      <p class="text-2xl sm:text-3xl font-extrabold text-white leading-tight tracking-tight whitespace-nowrap">
        {{ value }}
      </p>
      <p class="mt-2 text-[0.7rem] sm:text-xs text-emerald-100/95 tracking-[0.13em] uppercase font-semibold">
        {{ label }}
      </p>
      @if (note) {
